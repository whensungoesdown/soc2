...
add wave -divider
add wave -position end  result:/top_tb/tx
add wave -position end  result:/top_tb/u_top/peri_wen
add wave -position end  result:/top_tb/u_top/u_peri/uart_status
add wave -position end  result:/top_tb/u_top/u_peri/u_uart/utx/tx_data
add wave -position end  result:/top_tb/u_top/u_peri/tx_data_valid
add wave -position end  result:/top_tb/u_top/u_peri/tx_idle
add wave -position end  result:/top_tb/u_top/u_peri/u_uart/utx/ready
add wave -divider
...
add wave -position end  result:/top_tb/u_top/u_c7b/u_core/u_exu/u_lsu/pg_mode
add wave -position end  result:/top_tb/u_top/u_c7b/u_core/u_exu/u_lsu/match_dmw0
add wave -position end  result:/top_tb/u_top/u_c7b/u_core/u_exu/u_lsu/match_dmw1
