...
//    printf("System Halted.\n");
    ...
    screen_puts("\n");
    screen_puts("==========================================\n");
    screen_puts("!!! CRITICAL SYSTEM FAILURE: ALE EXCEPTION !!!\n");
    screen_puts("==========================================\n");
    screen_puts("Reason: Address Alignment Fault\n");
    screen_puts("------------------------------------------\n");
    // 注意：%llx 是 64 位 hex 打印格式，如果你的极简 screen_puts 不支持，可以用 %x
    screen_puts("Error PC (ERA) : "); 
    screen_print_hex(era); 
    screen_puts("Bad Address    : ");
    screen_print_hex(badv); 
    screen_puts("------------------------------------------\n");
    
    screen_puts("System Halted.\n");
...
void exception_handler_ine_panic (void)
{
    uint64_t era = read_csr_era();
    
    screen_puts("\n");
    screen_puts("==========================================\n");
    screen_puts("!!! CRITICAL SYSTEM FAILURE: INE EXCEPTION !!!\n");
    screen_puts("==========================================\n");
    screen_puts("------------------------------------------\n");
    screen_puts("Error PC (ERA) : "); 
    screen_print_hex(era); 
