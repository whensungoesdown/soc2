...
add wave -position end  result:/top_tb/u_top/cpu_ram_raddr
add wave -position end  result:/top_tb/u_top/cpu_ram_rdata
add wave -position end  result:/top_tb/u_top/cpu_ram_ren
add wave -position end  result:/top_tb/u_top/cpu_ram_waddr
add wave -position end  result:/top_tb/u_top/cpu_ram_wdata
add wave -position end  result:/top_tb/u_top/cpu_ram_wen
...
add wave -position end  result:/top_tb/u_top/u_ram_bridge/s1_wr_sel
add wave -position end  result:/top_tb/u_top/u_ram_bridge/s0_rd_sel
add wave -position end  result:/top_tb/u_top/u_ram_bridge/s1_rd_sel
